...
# Code imported from nav2_simple commander package (ros-planning/navigation2 repository)
# https://github.com/ros-planning/navigation2/blob/iron/nav2_simple_commander/nav2_simple_commander/robot_navigator.py
